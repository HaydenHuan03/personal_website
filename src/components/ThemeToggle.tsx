...
/**
 * Flips the `.dark` class on <html> and remembers the choice. Starts assuming
 * light (the server cannot know the theme) and syncs to the real class on
 * mount, so the morph only ever plays for an actual user toggle.
 */
